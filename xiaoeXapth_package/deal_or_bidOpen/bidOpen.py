...
class BidOpen(Base):
    ...
    input_bidMessage_button = "//div//span[contains(text(),'延长解密时间')]/../following-sibling::div//span[contains(text(),'录入唱标信息')]"#录入唱标信息
#     input_bidMessage_button ="//*[@id='wrap']/div[2]/div/div[1]/div[2]/div[2]/div/div[2]/span"
    ...
    def input_bidMessage_send_keys(self,num):#录入唱标信息
        ...
        for j in range(2,num):
            pageJumps = "//span[contains(text(),'录入唱标信息')]/../following-sibling::div//div[3]//ul//li[text()='"+str(j)+"']"#页面跳转
