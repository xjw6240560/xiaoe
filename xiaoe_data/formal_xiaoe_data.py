...
class Formal_xiaoe_data(Test_xiaoe_data):
    ...
    enterpriseName = ["漳州招投标测试企业", "国函通科技有限公司", "厦建设发展有限公司", "农大侠（厦门）信息技术有限公司"]
    ...
    workbench_url = t.workbench_url.replace('jiaoyi', 'xiaoeztb').replace('http', 'https')
